...
public class NoteActivity extends AppCompatActivity {
    ...
    public void initViews(){
        ...
        mNodeEditText.addTextChangedListener(new TextWatcher() {
            @Override
     ...
     * 为编辑器创建Memoto对象
     */
    private Memotos createMemotoForEditText(){
        Memotos memoto = new Memotos();
     ...
     * 恢复编辑状态
     */
    private void restoreEditText(Memotos memoto){
