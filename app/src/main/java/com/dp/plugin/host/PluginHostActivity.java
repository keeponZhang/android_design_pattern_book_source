...
public class PluginHostActivity extends Activity {
    public final String TAG = "android_dp_plugin_host";
...
//                PluginManager.getInstance().loadApk(includeApk);
    ...
    private void dexTest(String dexPath, String className) {
        ...
        String dexOutpout = getApplicationContext().getDir("dex", 0).getAbsolutePath() ;
        ClassLoader classLoader = getApplicationContext().getClassLoader() ;
        
        Log.e(TAG, "### out : " + dexOutpout + ", class loader : " + classLoader + " , dex path " + dexPath) ;
